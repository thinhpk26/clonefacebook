...
const HomeRight = () => {
    ...
    return (
        <section className="home-right container-scroll isPadding stop-select">
            <div className="duty-calc-height-scroll">
                <header className="home-right-head d-flex justify-content-between align-items-center mx-3 my-2">
                    <p className="fs-title m-0 fw-bold allow-select">Người liên hệ</p>
                ...
                <main className="list-relative">
                    ...
                    <section className='list-group'>
                        <header className='group-chat-title mx-3 my-2'>
                            <p className='fs-title m-0 fw-bold allow-seclect'>Cuộc trò chuyện nhóm</p>
                        </header>
                        {groups}
                    </section>
